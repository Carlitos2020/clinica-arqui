...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Estamos agredecidos por confiar en nosotros, puede editar su información de manera segura'),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    ...
                                    <div>
                                        <span class="heading">60kg</span>
                                        <span class="description">{{ __('Peso') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">1.65m</span>
                                        <span class="description">{{ __('Talla') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Lima-Perú') }}
                            </div>
                            
                            <hr class="my-4" />
                            <a href="#">{{ __('Verifica bien tus datos!!') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Perfil de Usuario') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-current-password">{{ __('Contraseña') }}</label>
                                    <input type="password" name="old_password" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('Contraseña') }}" value="" required>
